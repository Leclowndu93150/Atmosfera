...
public class SoundDefinitionsReloader extends SimplePreparableReloadListener<Void> {
    ...
    private static void loadSoundDefinitions(ResourceManager manager, String sourceFolder, Map<ResourceLocation, AtmosphericSoundDefinition> destination) {
        destination.clear();

        Map<ResourceLocation, Resource> resources = manager.listResources(sourceFolder + "/definitions", id -> id.getPath().endsWith(".json"));
    ...
    private static EnvironmentContext.Shape getShape(JsonObject json, ResourceLocation id) {
        if (json.has("shape")) {
    ...
    private static EnvironmentContext.Size getSize(JsonObject json, ResourceLocation id) {
        if (json.has("size")) {
    ...
    private static ImmutableCollection<AtmosphericSoundModifier.Factory> getModifiers(JsonObject json, ResourceLocation id) {
