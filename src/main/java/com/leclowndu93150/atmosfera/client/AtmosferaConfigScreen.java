...
public class AtmosferaConfigScreen {
    ...
    private static ConfigCategory buildVolumesCategory() {
        ...
        for (Map.Entry<ResourceLocation, Integer> entry : AtmosferaConfig.getVolumeModifiers().entrySet()) {
    ...
    private static ConfigCategory buildSubtitlesCategory() {
        ...
        for (Map.Entry<ResourceLocation, Boolean> entry : AtmosferaConfig.getSubtitleModifiers().entrySet()) {
            ResourceLocation id = entry.getKey();
